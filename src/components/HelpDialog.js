            ...
            <Dialog id={id} open={open} onClose={onClose}>
                ...
                <DialogContent>
                    <div className={classes.body}>
                        <DialogContentText>
                            Edit Screen by{' '}
                            <Chip size="small" label={'double click'} /> on the
                            screen name from sidebar.
                        </DialogContentText>

                        <DialogContentText>
                            Hold <Chip size="small" label={'shift'} /> while
                            scrolling to disable iframe scroll.
                        </DialogContentText>
                        ...
                        <DialogActions className={classes.dialogActions}>
                            ...
                            <Dialog open={isAppResetOpened}>
                                ...
                                <DialogContent>
                                    <DialogContentText>
                                        All screens & settings will be reset to
                                        initial state, you cannot undo this
                                        action.
                                    </DialogContentText>
                                </DialogContent>
                                <DialogActions>
